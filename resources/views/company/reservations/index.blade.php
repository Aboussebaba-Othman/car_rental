                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                <div class="flex justify-end space-x-2">
                                    ...
                                    @if(in_array($reservation->status, ['pending', 'payment_pending']))
                                        <form method="POST" action="{{ route('company.reservations.add-note', $reservation) }}" class="inline">
                                            @csrf
                                            <button type="button" class="text-gray-600 hover:text-gray-900 note-btn" title="Ajouter une note" data-reservation-id="{{ $reservation->id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
